<body class=" flex h-screen ">
	...
	<div class="flex flex-col items-center w-64 h-full overflow-hidden text-white bg-gray-900 rounded">
		...
		<div class="w-full px-2">
			<div class="flex flex-col items-center w-full mt-3 border-t border-gray-700">
				<a class="flex items-center w-full h-12 px-3 mt-2 rounded bg-gray-700 hover:text-gray-300" href="#">
